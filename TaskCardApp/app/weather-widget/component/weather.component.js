...
var WeatherComponent = (function () {
    function WeatherComponent(service) {
        ...
        //icon = new Skycons({ "color": "#FFF" });
        this.icon = new Skycons();
    ...
    WeatherComponent.prototype.setIcon = function () {
        this.icon.add("icon", this.weatherData.icon);
        this.icon.play();
    };
    WeatherComponent.prototype.setStyles = function () {
        if (this.weatherData.icon) {
            this.icon.color = constants_1.WEATHER_COLORS[this.weatherData.icon]["color"];
            //return WEATHER_COLORS["clear-day"];
            return constants_1.WEATHER_COLORS[this.weatherData.icon];
        }
        else {
            this.icon.color = constants_1.WEATHER_COLORS["default"]["color"];
